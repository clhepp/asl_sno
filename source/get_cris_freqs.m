...
ng = 0;   % number of guard channels you are using  
...
if (ng == 0) fnout = 'cris_freq_nogrd.mat'; end      % for ng=0.
if (ng == 2) fnout = 'cris_freq_2grd.mat'; end       % for ng=2.
save(fnout,'vchan','ichan');        

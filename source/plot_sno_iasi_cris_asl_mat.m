...
% ---------------- Basic Stats ------------------------------
btbias   = dbt - cbt;
 whos ibt cbt dbt nbr_abt nbr_cbt nbr_dbt btbias
ibm      = nanmean(ibt,2);
cbm      = nanmean(cbt,2);
dbm      = nanmean(dbt,2);
...
%nbr_dbsd = nanstd(nbr_dbt,0,3);
 whos ibm cbm dbm bias_mn bias_sd nbr_abm nbr_cbm nbr_dbm nbr_cbsd nbr_absd nbr_dbsd

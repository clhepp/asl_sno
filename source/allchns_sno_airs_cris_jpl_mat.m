...
%
% sanity plots
cbt = real(rad2bt(sa.fc(sa.ichns), sa.crad));
dbt = real(rad2bt(sa.fd(sa.ichns), sa.drad));
figure(10);clf;plot(sa.fc(sa.ichns), nanmean(cbt,2),'-', sa.fc(sa.ichns), nanmean(dbt,2),'-');
ich = 402   % (899.375)
